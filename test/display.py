...
try:
    ...
    print ("***draw line")
    draw.line([(40,20),(200,20)], fill = "BLUE",width = 25)
    draw.line([(40,20),(40,200)], fill = "BLUE",width = 25)
    draw.line([(40,200),(200,200)], fill = "BLUE",width = 25)
    draw.line([(200,20),(200,200)], fill = "BLUE",width = 25)
