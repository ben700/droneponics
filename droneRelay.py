...
#try:
    ...
    def buttonV1Pressed(pin, value):
        ...
        blynk.set_property(12, 'color', colours[value[0]])
        blynk.set_property(13, 'onColor', colours[value[0]])
        blynk.set_property(14, 'offBackColor', colours[value[0]])
        blynk.set_property(15, 'offColor', colours[value[0]])
