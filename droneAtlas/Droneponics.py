...
with open(str(appFolder) + "/config/device_config."+str(drone.gethostname())+".json") as f:
...
print("Success : Read config from " + str(appFolder) + "/config/device_config."+str(drone.gethostname())+".json")
...
def main():
    ...
    print("DroneLog")
    _dronelog = drone.DroneLog()
    _dronelog.log("Device Boot")
    
    print("DroneError apiError")
    _droneError = drone.DroneError()
    _droneError.manualError("manualError")
    print("DroneError apiError")
    _droneError.apiError("apiError")
    print("DroneError exceptionError")
    _droneError.exceptionError("exceptionError")
