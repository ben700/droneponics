...
class Solenoid:
   ...
   def __init__(self, _log, gpioPin, Name, *args, **kwargs):
       _log.info("Building Relay object for Solenoid " + Name)
       self._log = _log
   ...
   def turnOn(self, _log): 
       try:
          _log.info("Turning on Solenoid " + self.name)
          GPIO.output(self.gpioPin,GPIO.LOW) 
          _log.info("Turned on Solenoid " + self.name + " on pin " + str(self.gpioPin))
       except:
          _log.error("Except solenoidClass: Turning on Solenoid " + self.name)
   ...
   def turnOff(self, _log): 
       try:
           ...
           _log.error("Except solenoidClass: Turning off Solenoid " + self.name)
         
   def turnAuto(self, _log): 
       try:
           _log.info("Turning Solenoid " + self.name + " to auto") 
       except:
           _log.error("Except solenoidClass: Turning Solenoid " + self.name+ " to auto")
