...
class Dose:
   ...
   def buildDosePayload(self, payload, Target, Reading): 
       payload = '{{ "deviceTime": "{}", "deviceMAC": "{}", "doseLiquid": "{}", "volume": "{}", "targetReading": "{}", "lastReading": "{}"  }}'.format(int(time.time()), drone.get_mac(),self.name, self.dose, Target, Reading  )
       return payload
