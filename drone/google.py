...
def pubDeviceBootToGoolgeCloud(_MQTT_TOPIC, payload):
...
def pubDeviceBootToGoolgeCloud():
    ...
    return pubDeviceBootToGoolgeCloud(_MQTT_TOPIC, payload)
...
def pubEnviromentalReadingsToGoolgeCloud(dronePayload):
    ...
    return pubDeviceBootToGoolgeCloud(_MQTT_TOPIC, dronePayload.get())
