...
def updateGoogle(Temperature, Pressure, Humidity, lux, ir):
    ...
    values = [[str(datetime.datetime.now()), Temperature, Pressure, Humidity, lux, ir]]
    body = {'values' : values }
