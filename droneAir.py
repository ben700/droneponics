...
def blynk_data():
  ...
  #      bme680 = None
    ...
    if (tsl is not None):
        ...
        _log.debug("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@Going to process payload =" + str(payload.get()))
