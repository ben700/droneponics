...
void print_help() {
  ...
  if (k_val > 9) {
    Serial.println(F("You have a K10 probe"));
  }
  else if (k_val > .9) {
    Serial.println(F("You have a K1 probe"));
  }
  else if (k_val > .09) {
    Serial.println(F("You have a K0.1 probe"));
  }
  ...
  if (k_val > 9) {
  Serial.println(F("ec:k,10"));
  }
  else if (k_val > .9) {
    Serial.println(F("ec:k,1"));
  }
  else if (k_val > .09) {
    Serial.println(F("ec:k,0.1"));
  }
  Serial.println(F("ec:cal,dry           calibrate a dry EC probe                              "));
  Serial.println(F("ec:cal,2760     calibrate EC probe to 2,76 cms  i.e the one from shop      "));
